...
Publicly available datasets gathered from our experiments. Each links to its repository, with documentation, licensing, and a citable reference.

---

### Voluntary & Involuntary Blink Dataset and Model

Eye-tracking recordings from 44 participants, annotated for voluntary and involuntary blinks using eye-openness metrics, together with a trained neural-network classifier (92% test accuracy). Openly available for research on automated blink detection and gaze-based interaction.
...
<!--
  ...
  One or two sentences on what it contains and how it was collected.

  <a href="REPO_URL" target="_blank" rel="noopener"><strong>View on GitHub →</strong></a>

  Associated paper: Author(s) (Year). *Title.* Venue. [doi:...](https://doi.org/...)
-->
